...
hi Folded	term=standout ctermfg=4 ctermbg=NONE guifg=royalblue1 guibg=white
hi FoldColumn	term=bold ctermfg=blue ctermbg=white guifg=royalblue3 guibg=white
...
hi VertSplit	term=NONE cterm=NONE gui=bold,reverse guifg=gray40
